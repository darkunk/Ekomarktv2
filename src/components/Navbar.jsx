import React from 'react'
    ...
    import { 
      searchOutline, notificationsOutline, cartOutline, personAddOutline, logInOutline, ellipsisHorizontalOutline,
      womanOutline, manOutline, bodyOutline, phonePortraitOutline, gameControllerOutline, homeOutline,
      timeOutline, footballOutline, brushOutline, briefcaseOutline, walkOutline, hammerOutline, bookOutline
    } from 'ionicons/icons'
              ...
              <div className="flex items-center h-full space-x-8">
                ...
                <div className="relative flex-1">
                  <input
                    ...
                    className="pl-4 pr-4 py-2 rounded-full border border-gray-300 focus:outline-none focus:ring-1 focus:ring-primary w-full"
                  />
